      ...
      <!-- Text input-->
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <a href="index.php" class="btn btn-danger btn-large">Cancelar</a>
            </div>
        </div>
...
if(isset($_POST['envia'])){
  ...
  //coloco como primeiro parâmetro do $FILES o nome arq pois é o nome da caixa de inserção de arquivo no formulário
    ...
    //inserindo dados do endereco
        ...
        echo "<script> alert ('Postagem Criada com Sucesso '); location.href='postaradm.php'</script>"; exit;
